...
const faqs = [
  {
    ...
    answer: "Drug Decider is a set of algorithms which predict how a patient would have performed in a number of past clinical trials.  By comparing these predictions for different medications, a patient can better understand how their unique demographics and symptom profiles may make them a better responder to some treatments than others."
  },
  {
